define(function(require, exports, module) {
    // import dependencies
        ...
        var WIDTH = (totalWidth)/ NoX;
        var HEIGHT = (totalHeight) / NoY;

        var NoXBigOne = 4;
        var NoYBigOne = 6;
        var bigXXlate = 3 * WIDTH;
        var bigYXlate = HEIGHT;
        var WIDTHBigOne = (totalWidth/2) / NoXBigOne;
        var HEIGHTBigOne = totalHeight / NoYBigOne;
        var DURATION = 500;
        //Global data
        var images = [];
        var originMatrixs = [];
        ...
        function init() {
            ...
            for (var j = 0; j < NoYBigOne; j++)
                for (var i = 0; i < NoXBigOne; i++) {
                    ...
                    console.log('translate ' +(i) * WIDTHBigOne + bigXXlate)
                    var newMatrix = Transform.translate((i) * WIDTHBigOne + bigXXlate, (j) * HEIGHTBigOne + bigYXlate,
                        0);
        ...
        function bigOne(e) {
            ...
            modifiers[mainIndex].setSize([WIDTHBigOne - marginBig, HEIGHTBigOne - marginBig], {
                duration: DURATION,
                curve: 'easeInOut'
            }, function () {
                animating = false;
